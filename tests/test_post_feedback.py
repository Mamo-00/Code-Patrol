...
from src.github.post_feedback import post_comment_to_pr

def test_post_comment_to_pr():
    with patch('src.github.post_feedback.Github') as mock_github:
        ...
        with patch('src.github.post_feedback.os.getenv', side_effect=lambda k: {'GITHUB_TOKEN': 'fake-token', 'GITHUB_REPOSITORY': 'repo/name', 'PR_NUMBER': '123'}.get(k, None)):

...
from src.analysis.code_review import get_prompt, main

def test_get_prompt():
    diff = "diff --git a/src/analysis/code_review.py b/src/analysis/code_review.py"
    ...
    expected_prompt = "**developer: Provide detailed, in-depth analysis of the code.**\n\n" \
                      ...
                      "```diff\ndiff --git a/src/analysis/code_review.py b/src/analysis/code_review.py\n```"
    assert prompt == expected_prompt


@patch('src.analysis.code_review.openai.Completion.create')
@patch('src.analysis.code_review.os.getenv')
